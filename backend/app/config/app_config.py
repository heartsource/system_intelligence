...
class AppConfig:
    def __init__(self):
        ...
        self.chroma_host = os.getenv('CHROMA_HOST', "chroma-server")
        self.chroma_port = int(os.getenv('CHROMA_PORT', 8000))
        self.chroma_db_path = os.getenv('CHROMA_DB_PATH', "../chromadb")
        self.chroma_db_name = os.getenv('CHROMA_DB_NAME', "system_intelligence_chromadb")
        self.chroma_db_collection_name = os.getenv('CHROMA_DB_COLLECTION_NAME', "system_intelligence_collection")
